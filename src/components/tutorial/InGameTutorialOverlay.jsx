...
import { getTutorialStep, TUTORIAL_FLOW } from '../../game';
  ...
  switch (step?.highlight) {
    ...
    case 'swapBlind':
      return {
        ...
        right: Math.min(window.innerWidth - 20, vw * 0.82),
...
export default function InGameTutorialOverlay({
  ...
  if (typeof tutorialStep === 'string') {
    return (
      <ScriptTutorialOverlay
