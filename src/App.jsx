  ...
  useEffect(()=>{
    ...
    timerRef.current=setTimeout(()=>{
      ...
      try{
        ...
        const P_actionBeforeHandLimit=(_aiHandLimitBeforePlayers||_playersBeforeEndTurnReplay||P_actionPreInspection).map(p=>p._pendingAnimDeath?{...p,_pendingAnimDeath:false}:p);
