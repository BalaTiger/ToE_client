...
export default function Game(){
  ...
  useAnimationAudioEffects({ anim, playApophisEclipseSound, playThrowStoneThrowSound, playThrowStoneRollingSound, playEarthquakeSound, playGeomagneticReversalSound, playStartledBatsSound, playRopeSound, playUndergroundSpringDropletSound, playVolcanoSound });
